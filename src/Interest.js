      ...
      <div className="system p-5" id="article">
        ...
        <div className="article-section mb-3" data-aos="zoom-out-down">
          <a
            ...
            href="https://adityabhavsar.com/pursue-passions-not-paychecks/"
            rel="noopener noreferrer"
            target="_blank"
          >
            Pursue passions, not paycheques
          </a>
        </div>
        <div className="article-section mb-3" data-aos="zoom-out-down">
          <a
        ...
        <div className="article-section mb-3" data-aos="zoom-out-down">
          <a
            className="article-link"
            href="https://www.healthyplace.com/blogs/buildingselfesteem/2015/09/why-self-care-is-important-for-your-mental-physical-health"
            rel="noopener noreferrer"
            target="_blank"
          >
        ...
        <div className="article-section mb-3" data-aos="zoom-out-down">
          <a
            className="article-link"
            href="https://www.health.harvard.edu/newsletter_article/why-we-should-exercise-and-why-we-dont"
            rel="noopener noreferrer"
            target="_blank"
          >
            Exercise is wise
