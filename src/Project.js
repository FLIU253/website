			...
			<div className="project" id="#project" style={{ backgroundColor: 'rgb(10, 25, 47)' }}>
				<div className="container pb-4">
					...
					<div className="project-grid mb-5">
						<div>
							<a href="https://geopins.fliu253.now.sh/" target="_blank" rel="noopener noreferrer">
								<img
									className="card-img"
									src={geoPins}
									alt="Card cap"
						...
						<div className="featured-description" data-aos="fade-left" data-aos-duration="1500">
							...
							<p className="project-description">
								GeoPin is a real time application that reads the user's current location and allows the
								user to drop pins on a map and write a message about the location for other users to
								see. APIs used include Google login and Mapbox.
							</p>
					...
					<div className="project-grid mb-5">
						<div className="featured-description" data-aos="fade-right" data-aos-duration="1500">
							<p style={{ marginBottom: '0' }}>Featured Project</p>
							<h4 className="project-name">JAMS: Job Application Management System</h4>
							<p className="project-description">
								A job management system that allows users to track all of their job application date
								including: places to apply, places applied to, upcoming interviews, rejections, and
								offered positions.
							</p>
							<ul className="language-list">
								<li>React.Js</li>
						...
						<div>
							<a href="https://jam-system.herokuapp.com/" target="_blank" rel="noopener noreferrer">
								<img
									className="card-img"
									src={jams}
									alt="Card cap"
					...
					<div className="project-grid mb-5">
						...
						<div className="featured-description" data-aos="fade-left" data-aos-duration="1500">
							...
							<p className="project-description">
								A fun application that can generate a random anime for the user using MAL's unofficial
								API. This application can also create an anime tier list based on a user's MAL account
								username.
							</p>
							<ul className="language-list">
								<li>Vue.Js</li>
					...
					<div className="project-grid mb-5 mt-5">
						<div className="text-left" data-aos="fade-right" data-aos-duration="1500">
							...
							<p className="project-description">
								Replace new tab page with a randomly generated anime wallpaper. The new tab page also
								displays the current temperature and location of the user. This extension also shows the
								current anime airing schedule.
							</p>
					...
					<div className="project-grid">
						...
						<div data-aos="fade-left" data-aos-duration="1000">
							{this.state.clothingStoreHover === true ? (
								<div className="card-info" data-aos="fade-left" onClick={this.onClothingStoreHover}>
									<h3 className="card-info-title">
										<strong>Clothing Store Application</strong>
									</h3>
									<hr className="line" />
									<p>
										A clothing store like application built to learn how to use redux with react.
										This application uses Firebase and Stripe API to simulate logins and payments
										respectively.
									</p>
									<p style={{ color: '#5E9516' }}>
										<strong>Built with:</strong>
						...
						<div data-aos="fade-right" data-aos-duration="1000">
							{this.state.reactImdbHover === true ? (
								<div className="card-info" data-aos="fade-right" onClick={this.onreactImdbHover}>
									<h3 className="card-info-title">
										<strong>React IMDB</strong>
									</h3>
									<hr className="line" />
									<p>A movie searching website that is powered by the movie DB api.</p>
									<p style={{ color: '#5E9516' }}>
										<strong>Built with:</strong>
									</p>
						...
						<div data-aos="fade-left" data-aos-duration="1000">
							{this.state.slackHover === true ? (
								<div className="card-info" data-aos="fade-left" onClick={this.onSlackHover}>
									<h3 className="card-info-title">
										<strong>React Slack Clone</strong>
									</h3>
									<hr className="line" />
									<p>
										A React slack clone that beheaves just like slack! Functionalities include:
										direct messaging a user, uploading pictures to chat, searching for messages and
										many more!
									</p>
									<p style={{ color: '#5E9516' }}>
										<strong>Built with:</strong>
