    ...
    return (
      <div className="all-content">
        <div className="burger-nav" data-aos="fade-down">
          <i
            className="fas fa-bars dropdown-nav"
          ...
          {this.state.burgerActive && (
            <div className="burger-tag">
              ...
              <AnchorLink
                ...
                data-aos="fade-down"
                href="#landing"
                style={{ color: 'white', textDecoraction: 'none' }}
              >
                Profile
              </AnchorLink>
              <br />
        ...
        <div className="sidebar">
          <ul>
            ...
            <li
              className={
                this.state.articleActive
                  ? 'list-section article-tag'
                  : 'list-section'
              }
            >
        ...
        <GithubCorner
          href="https://github.com/FLIU253/FLIU253"
          direction="left"
          size="100"
          bannerColor="#000000"
