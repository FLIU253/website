      ...
      <div className="container text-center" style = {{"color" : "#8892b0"}}>
        <div className="row pt-4">
          <div className="col">
            ...
            <span data-aos="zoom-out-right" data-aos-duration="2000">Passionate</span>
          </div>
          <div className="col">
            <i className="fas fa-users" data-aos="fade-right" />
            <span data-aos="zoom-out-right" data-aos-duration="2000">Team-Oriented</span>
          </div>
        </div>
        <div className="row pt-4">
          <div className="col">
            <i className="fas fa-brain" data-aos="fade-right" />
            <span data-aos="zoom-out-right" data-aos-duration="2000">Open-Minded</span>
          </div>
          <div className="col">
            <i className="fas fa-clipboard-check" data-aos="fade-right" />
            <span data-aos="zoom-out-right" data-aos-duration="2000">Problem-Solver</span>
          </div>
        </div>
